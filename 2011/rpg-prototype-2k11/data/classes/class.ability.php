...
class mmrpg_ability {
  ...
  public function mmrpg_ability(){
    ...
    if (!isset($this->battle->values['abilities'][$this->ability_id])){
      $this->battle->values['abilities'][$this->ability_id] = $this->export_array();
    }
  ...
  public function ability_load($this_abilityinfo){
    ...
    if (isset($_SESSION['RPG2k11']['ABILITIES'][$this->battle->battle_id][$this->player->player_id][$this->robot->robot_id][$this_abilityinfo['ability_id']])){
      $this_abilityinfo = $_SESSION['RPG2k11']['ABILITIES'][$this->battle->battle_id][$this->player->player_id][$this->robot->robot_id][$this_abilityinfo['ability_id']];
    }
...
//    }
  ...
  public function update_session(){
    ...
    $_SESSION['RPG2k11']['ABILITIES'][$this->battle->battle_id][$this->player->player_id][$this->robot->robot_id][$this->ability_id] = $this_data;
