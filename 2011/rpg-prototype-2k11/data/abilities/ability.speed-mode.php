...
$ability = array(
  ...
  'ability_function' => function($objects){
    ...
    // Increase this robot's speed by 30% after charging
    $this_robot->robot_speed = $this_robot->robot_speed + ceil($this_robot->robot_base_speed * 0.30);
    // Decrease this robot's attack by 15%
    $this_robot->robot_attack = $this_robot->robot_attack - ceil($this_robot->robot_base_attack * 0.15);
    // Decrease this robot's defense by 15%
    $this_robot->robot_defense = $this_robot->robot_defense - ceil($this_robot->robot_base_defense * 0.15);
    ...
    $this_robot->robot_frame = 'defend';
    $event_body = "Attack and defense fell by 15%&hellip;<br />";
    $event_body .= "Speed rose by 30%!";
    $this_battle->events_create($this_robot, $target_robot, $event_header, $event_body, array('console_show_target' => false, 'ability_results' => $this_ability->ability_results));
