...
if (strstr($MMRPG_CONFIG['DOMAIN'], 'local.')){
  $MMRPG_CONFIG['ROOTDIR'] = $mmrpg_root_dir.'2011/rpg-prototype-2k11/'; // System Root DIR
  $MMRPG_CONFIG['ROOTURL'] = $mmrpg_root_url.'2011/rpg-prototype-2k11/'; // System Root URL
