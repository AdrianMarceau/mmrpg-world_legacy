...
$abilities[] = array('Guts Man', 'Super', 'Arm', 'impact', 2);  // Super Arm
...
$abilities[] = array('Heat Man', 'Atomic', 'Fire', 'flame', 2);  // Atomic Fire
$abilities[] = array('Flash Man', 'Time', 'Stopper', 'time', 2);  // Time Stopper
...
// MegaMan 3
$abilities[] = array('Gemini Man', 'Gemini', 'Laser', 'space', 1);
...
// MegaMan 4
$abilities[] = array('Bright Man', 'Flash', 'Stopper', 'time', 1);  // Flash Stopper
$abilities[] = array('Dive Man', 'Dive', 'Missile', 'missile', 1); // Dive Missile
$abilities[] = array('Drill Man', 'Drill', 'Bomb', 'earth', 1);  // Drill Bomb
$abilities[] = array('Dust Man', 'Dust', 'Crusher', 'impact', 1);
$abilities[] = array('Pharaoh Man', 'Pharaoh', 'Shot', 'flame', 1);  // Pharaoh Shot
$abilities[] = array('Ring Man', 'Ring', 'Boomerang', 'cutter', 1);  // Ring Boomerang
...
$abilities[] = array('Napalm Man', 'Napalm', 'Bomb', 'explode', 1);
$abilities[] = array('Crystal Man', 'Crystal', 'Eye', 'shadow', 1);
...
$abilities[] = array('Plant Man', 'Plant', 'Barrier', 'nature', 1);
...
$abilities[] = array('Junk Man', 'Junk', 'Shield', 'earth', 1);  // DWN. 050 Junk Man
$abilities[] = array('Burst Man', 'Danger', 'Wrap', 'explode', 1);  // DWN. 051 Burst Man
$abilities[] = array('Cloud Man', 'Thunder', 'Bolt', 'electric', 1);  // DWN. 052 Cloud Man
$abilities[] = array('Spring Man', 'Wild', 'Coil', 'impact', 1);  // DWN. 053 Spring Man
$abilities[] = array('Slash Man', 'Slash', 'Claw', 'cutter', 1);  // DWN. 054 Slash Man
...
$abilities[] = array('Clown Man', 'Thunder', 'Claw', 'electric', 1);  // DWN. 060 Clown Man
$abilities[] = array('Search Man', 'Homing', 'Sniper', 'missile', 1);  // DWN. 061 Search Man
$abilities[] = array('Frost Man', 'Ice', 'Wave', 'freeze', 1);  // DWN. 062 Frost Man
$abilities[] = array('Grenade Man', 'Flash', 'Bomb', 'explode', 1);  // DWN. 063 Grenade Man
$abilities[] = array('Aqua Man', 'Water', 'Balloon', 'water', 1);  // DWN. 064 Aqua Man

// MegaMan 8.5
$abilities[] = array('Dynamo Man', 'Lightning', 'Bolt', 'electric', 1);  // KGN. Dynamo Man
$abilities[] = array('Cold Man', 'Ice', 'Wall', 'freeze', 1);  // KGN. Cold Man
...
// MegaMan 9
$abilities[] = array('Concrete Man', 'Concrete', 'Shot', 'impact', 1);  // DLN. 065 Concrete Man
...
$abilities[] = array('Jewel Man', 'Jewel', 'Satellite', 'earth', 1);  // DLN. 069 Jewel Man
...
$abilities[] = array('Galaxy Man', 'BlackHole', 'Bomb', 'space', 1);  // DLN. 072 Galaxy Man

// MegaMan 10
$abilities[] = array('Blade Man', 'Triple', 'Blade', 'cutter', 1);  // DWN. 073 Blade Man
$abilities[] = array('Pump Man', 'Water', 'Shield', 'water', 1);  // DWN. 074 Pump Man
$abilities[] = array('Commando Man', 'Commando', 'Bomb', 'explode', 1);  // DWN. 075 Commando Man
$abilities[] = array('Chill Man', 'Chill', 'Spike', 'freeze', 1);  // DWN. 076 Chill Man
$abilities[] = array('Sheep Man', 'Thunder', 'Wool', 'electric', 1);  // DWN. 077 Sheep Man
