...
echo "{$asset_base_url}styles/master.css?{MMRPG_CONFIG_CACHE_DATE}\r\n";
echo "{$asset_base_url}styles/mobile.css?{MMRPG_CONFIG_CACHE_DATE}\r\n";
echo "{$asset_base_url}scripts/jquery.js\r\n";
echo "{$asset_base_url}scripts/master.js?{MMRPG_CONFIG_CACHE_DATE}\r\n";
...
echo "{$asset_base_url}images/assets/vertical-gradient_energy-bar.gif\r\n";
...
if (!empty($mmrpg_index_robots)){
  foreach ($mmrpg_index_robots AS $robot_token => $this_robot){
    ...
    foreach ($robot_sprite_sizes AS $this_size){
      $this_filename = "images/sprites/robots/robot_{$this_robot['robot_token']}_{$this_size}x{$this_size}.png\r\n";
...
echo "{$asset_base_url}scripts/battle.php\r\n";
