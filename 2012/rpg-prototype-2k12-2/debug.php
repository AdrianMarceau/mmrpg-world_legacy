...
elseif ($this_request_type == 'battles'){
  if ($this_request_action == 'create'){ $_SESSION['RPG2k12-2']['GAME']['values']['battle_complete'][$this_request_token] = $this_request_token; }
  elseif ($this_request_action == 'delete'){ unset($_SESSION['RPG2k12-2']['GAME']['values']['battle_complete'][$this_request_token]); }
...
elseif ($this_request_type == 'robots'){
  ...
  if ($this_request_action == 'create'){
    ...
    $robot_info = $mmrpg_index['robots'][$robot_reward_info['token']];
    ...
    if (!empty($this_robot_rewards['abilities'])){
      foreach ($this_robot_rewards['abilities'] AS $ability_reward_key => $ability_reward_info){
        ...
        if ($this_robot_points >= $ability_reward_info['points']){
          ...
          $ability_info = $mmrpg_index['abilities'][$ability_reward_info['token']];
    ...
    //$_SESSION['RPG2k12-2']['GAME']['values']['battle_rewards'][$this_request_token_player]['player_robots'][$this_request_token_robot] = $this_request_token_robot;
  }
  elseif ($this_request_action == 'delete'){ unset($_SESSION['RPG2k12-2']['GAME']['values']['battle_rewards'][$this_request_token_player]['player_robots'][$this_request_token_robot]); }
...
<?
  ...
  foreach ($mmrpg_index['players'] AS $player_token => $this_playerinfo){
    ...
    foreach ($this_playerinfo['player_robots'] AS $this_key => $this_robotinfo){
      ...
      $this_robotinfo = array_replace($mmrpg_index['robots'][$robot_token], $this_robotinfo);
