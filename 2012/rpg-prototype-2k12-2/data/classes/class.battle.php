          ...
          if ($target_player->counters['robots_active'] == 0){
            ...
            if ($this_player->player_side == 'left'){
              ...
              if ($this->counters['battle_turn'] < $this->battle_turns
                ...
                $this_half_points = $this->battle_points * 0.10;
                $this_turn_points = ceil($this_half_points * ($this->battle_turns / $this->counters['battle_turn']));
                /*
                $this_turn_diff = $this->battle_turns - $this->counters['battle_turn'];
                $this_half_points = $this->battle_points / 2;
                $this_turn_points = ceil($this_half_points * ($this_turn_diff / $this->battle_turns));
                if ($this_turn_points < 0){ $this_turn_points = 0; }
                elseif ($this_turn_points > $this_half_points){ $this_turn_points = $this_half_points;  }
                */
              }
              else {
                $this_turn_points = 0;
              ...
              if (!empty($target_player->values['robots_disabled'])){
                foreach ($target_player->values['robots_disabled'] AS $temp_key => $temp_info){
                  ...
                  $_SESSION['RPG2k12-2']['GAME']['values']['robot_database'][$temp_info['robot_token']] = array('robot_token' => $temp_info['robot_token']);
                }
              }
