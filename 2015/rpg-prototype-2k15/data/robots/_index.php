...
if (!empty($_SESSION['RPG2k15'][mmrpg_game_token()]['values']['robot_index'])){
  // The session-based robots exist, so merge them with the index
  $mmrpg_index['robots'] = array_merge($mmrpg_index['robots'], $_SESSION['RPG2k15'][mmrpg_game_token()]['values']['robot_index']);
}
