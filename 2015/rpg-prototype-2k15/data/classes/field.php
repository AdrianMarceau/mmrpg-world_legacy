...
class mmrpg_field {
  ...
  public function field_load($this_fieldinfo){
    ...
    if (isset($_SESSION['RPG2k15']['FIELDS'][$this->battle->battle_id][$this_fieldinfo['field_id']])){
      $this_fieldinfo = $_SESSION['RPG2k15']['FIELDS'][$this->battle->battle_id][$this_fieldinfo['field_id']];
    }
  ...
  public function update_session(){
    ...
    $_SESSION['RPG2k15']['FIELDS'][$this->battle->battle_id][$this->field_id] = $this_data;
