...
$this_prototype_awards = !empty($_SESSION['RPG2k15'][$session_token]['values']['prototype_awards']) ? $_SESSION['RPG2k15'][$session_token]['values']['prototype_awards'] : array();
...
$_SESSION['RPG2k15'][$session_token]['values']['prototype_awards'] = $this_prototype_awards;
