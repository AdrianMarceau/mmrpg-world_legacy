...
$html_title_text = 'RPG Display Tests 001/003 | '.$html_title_text;
$html_content_title = $html_content_title.' | RPG Display Tests 001/003';
$html_content_description = 'Several different layouts for a browser-based Mega Man RPG were experimented with during development.  This is the first of the battle system layouts.';
