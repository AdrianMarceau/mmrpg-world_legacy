...
$PLUTOCMS_CONFIG['CORE']['ROOTDIR'] = LEGACY_MMRPG_ROOT_DIR.'2010/rpg-loading-tests/'; // System Root DIR
$PLUTOCMS_CONFIG['CORE']['ROOTURL'] = LEGACY_MMRPG_ROOT_URL.'2010/rpg-loading-tests/'; // System Root URL
